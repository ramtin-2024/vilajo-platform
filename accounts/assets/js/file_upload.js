...
const pondInput1 = FilePond.create(
  ...
  {
    labelIdle: `<i class="fa-solid fa-cloud-upload fa-fw f-s-25"></i> <div class="filepond--label-action text-decoration-none">فایل‌های خود را آپلود کنید</div>`,
  }
);

FilePond.create(document.querySelector('#filepondsolid1'), {
  labelIdle: `<i class="fa-solid fa-cloud-upload fa-fw f-s-10 text-secondary"></i> <div class="filepond--label-action text-decoration-none">فایل‌های خود را آپلود کنید</div>`,
  imagePreviewHeight: 170,
  imageCropAspectRatio: '1:1',
  imageResizeTargetWidth: 100,
  imageResizeTargetHeight: 100,
