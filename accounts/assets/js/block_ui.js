$(document).ready(function () {
    ...
    $('#myButton3').click(function () {
        $('.block-msg-card').block({
            message: '<span class="msg-card"> پیام سفارشی...</span>',
            timeout: 3000,
            overlayCSS: {
                backgroundColor: 'rgba(var(--dark), 0.8)',
                opacity: 0.8,
    ...
    $('#myButton4').on('click', function() {
        ...
        window.setTimeout(function () {
			message.html('<div class="mutiple-msg"> در حال بارگذاری ...</div>');
        }, 0);

        window.setTimeout(function () {
			message.html('<div class="mutiple-msg">تنها یک دقیقه...</div>');
        }, 4000);

        window.setTimeout(function () {
            message.html(' <button type="button" class="btn btn-info">اطلاعات</button>');
        }, 5000);
    ...
    $('#myButton5').click(function () {
        $('.block-msg-animation-card').block({
            message: '<div class="bolckui-msg-box"><div class="loader-container-box"><div class="loader"></div></div></span>&nbsp; در حال بارگذاری ...</div>',
            timeout: 3000,
            overlayCSS: {
                backgroundColor: 'rgba(var(--dark), 0.8)',
                opacity: 0.8,
    ...
    $('#myButton6').click(function () {
        $('.unblock-callback').block({
            ...
            onUnblock: function() {
                alert('صفحه اکنون از حالت مسدود خارج شده است. محو شدن کامل شد..');
            }
        });
    });
    $('#myButton7').click(function () {
        $('.block-callback').block({
            ...
            onBlock: function() {
                alert('صفحه اکنون مسدود شده است، FadeIn کامل شده است.');
            }
        });
    });
