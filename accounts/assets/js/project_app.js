  ...
  const files = document.querySelector(".file_upload").files;
	return `
           ...
           <div class="card-header">
             <div class="d-flex align-items-center">
               ...
               <a href="project_details.html" target="_blank" class="flex-grow-1 ps-2">
                 ...
                 <div class="text-muted f-s-14">مدیر</div>
               </a>
               <div class="dropdown">
           ...
           <div class="card-body">
             <div class="d-flex">
               <div>
                 <h6 class="text-dark f-s-14">تاریخ شروع: <span class="text-success">${$('#startDate').val()}</span></h6>
                 <h6 class="text-dark f-s-14">تاریخ پایان: <span class="text-danger">${$('#endDate').val()}</span></h6>
               </div>
             ...
             <div class="text-end mb-2" >
               <span class="badge text-light-primary">نوار پیشرفت</span>
             </div>
           ...
           <div class="card-footer">
             <div class="row">
               <div class="col-6">
                 <span class="text-dark f-w-600" ><i class="ti ti-brand-wechat"></i> 20 عضو</span>
               </div>
               <div class="col-6">
