...
const typed = new Typed("#highlight-typed", {
  stringsElement: '#typed-strings',
    strings:['<span class="highlight-text" >کار<span class="txt-shadow">کار</span></span>','<span class="highlight-text" >اهداف<span class="txt-shadow">اهداف</span></span>','<span class="highlight-text" >پروژه‌ها<span class="txt-shadow">پروژه‌ها</span></span>'],
  typeSpeed: 100,
  backSpeed: 50,
  loop: true,
});
