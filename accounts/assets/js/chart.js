...
Chart.defaults.font.family = '"Estedad-VF", sans-serif';
...
new Chart(ctx, {
    type: 'bar',
    data: {
        labels: ["ژان", "فوریه", "مارس", "آوریل", "مه", "ژوئن", "ژوئیه"],
        datasets: [{
            label: "مجموعه داده #1",
...
new Chart(chart5, {
    type: 'doughnut',
    data: {
        labels: ["ژان", "فوریه", "مارس", "آوریل", "مه"],
        datasets: [
            {
                label: "مجموعه داده #1",
                backgroundColor: [
...
new Chart(chart8, {
    type: 'pie',
    data: {
        labels: ['به طور کلی بله', 'به طور کلی خیر', 'گروه الف بله', 'گروه الف خیر', 'گروه ب بله', 'گروه ب خیر', 'گروه ج بله', 'گروه ج خیر'],
        datasets: [
            {
