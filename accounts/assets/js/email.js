...
function emailBoxContent() {
    ...
    return `
	 <div class="mail-box">
       ...
       <div>
         <p class="text-center">23 سپتامبر</p>
       ...
       <div>
         <div class="btn-group dropdown-icon-none">
           ...
           <ul class="dropdown-menu">
             <li><a class="dropdown-item" href="#"><i class="ti ti-archive"></i> بایگانی </a></li>
             <li><a class="dropdown-item" href="#"><i class="ti ti-trash"></i> Delete </a></li>
             <li><a class="dropdown-item" href="#"><i class="ti ti-mail-opened"></i> خواندن ایمیل </a>
             </li>
           </ul>
         </div>
       </div>
