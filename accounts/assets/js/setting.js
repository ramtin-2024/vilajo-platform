...
// delet button js //
  ...
  $('#account_delete').on('click', function () {
    Swal.fire({
        title: 'آیا از حذف حساب مطمئنید؟',
        text: "شما قادر به بازگرداندن این نخواهید بود!",
        icon: 'warning',
...
var options = {
  ...
  name: 'زمان صرف شده',
  type: 'column',
  data: [35, 45, 32, 40, 35, 38, 40].reverse()
}, {
  name: 'کل زمان',
  type: 'line',
  data: [30, 25, 36, 30, 40, 35, null].reverse()
}],
  chart: {
  height: 280,
  type: 'line',
...
xaxis: {
  type: 'category',
  categories: ['ش', 'ی', 'د', 'س', 'چ', 'پ', 'ج'].reverse(),
  labels: {
    style: {
      fontSize: '14px',
